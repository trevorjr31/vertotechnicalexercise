...
--
-- Host: 127.0.0.1    Database: vertoex
-- ------------------------------------------------------
...
--
-- Current Database: `vertoex`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `vertoex` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `employees` VALUES (1,'Trevor','Harvey','1','Sales'),(2,'Joe','Smith','2','Marketing'),(3,'Mike','Williams','3','Engineering'),(4,'Liz','Williamsom','4','Customer Service'),(5,'Sam','Bennett','5','Marketing'),(6,'Bill','Smithers','6','Engineering'),(7,'Corey','Simone','7','Sales'),(8,'Stacey','Shapre','8','Product Management'),(9,'Mareena','Wallace','9','Engineering'),(10,'Charlene','Hassan','10','Quality Control'),(11,'Jamil','Hassan','11','Engineering'),(12,'Simay','Onder','12','Sales'),(13,'Polka','Roo','13','Product Management'),(14,'Kitty','Bear','14','Engineering'),(15,'Allen','Iverson','15','Sales'),(16,'Jennifer','Lopez','16','Quality Control'),(17,'Ruby','Richardson','17','Engineering'),(18,'Anastasia','Robertson','18','Project Management'),(19,'Danny','Loo','19','Finance'),(20,'Teresa','Fisher','20','Quality Control'),(21,'Kim','LaRunsa','21','Marketing'),(22,'Eve','Calgrid','22','Finance'),(23,'Mickey','Mouse','23','Sales'),(24,'Peter','Parker','24','Product Management'),(25,'Iama','Wokerhere','25','Human Resources'),(26,'First','Last','26','Engineering'),(27,'Twenty','Eight','27','Quality Control'),(28,'Wolf','Ofwallst','28','Finance'),(29,'Star','Wars','29','Project Management'),(30,'Bill','Bellichek','30','Project Management'),(58,'Mike','Miller','58','Engineering');
...
INSERT INTO `users` VALUES (19,'trevor','$2b$10$iJJjogKUAF.eR0gBJFwwcOp0a6DMogy4j3DYoc8T.AzDskteEzY5u'),(20,'mmiller123','$2b$10$YMH5Ds1Jkfiq171RameKfu9pGtaY8TKNvbQQMHH6zYhAfpodsgh6C'),(21,'mwallace123','$2b$10$5/gUiW3sJdU0PblCN7hP0.V5XlFvcsIaGHNBW5hkizvdQhJZ.0lqW'),(22,'vertohealth','$2b$10$i.k/19wTsSVEb4oXfKEQeeI87NrZrAgL1g/66bi7Iiznobd/bzJJy'),(23,'testaccount','$2b$10$eyXY28C.axDh3zjE2mT4FeCKlV.QzxFqzF/RHgNq4gcIDXwrVQBoW');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-06-27 23:21:42',NULL),('diagnostics.include_raw','OFF','2021-06-27 23:21:42',NULL),('ps_thread_trx_info.max_length','65535','2021-06-27 23:21:42',NULL),('statement_performance_analyzer.limit','100','2021-06-27 23:21:42',NULL),('statement_performance_analyzer.view',NULL,'2021-06-27 23:21:42',NULL),('statement_truncate_len','64','2021-06-27 23:21:42',NULL);
...
-- Dump completed on 2021-10-04  9:17:33
